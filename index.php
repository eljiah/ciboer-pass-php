        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <div class="d-flex justify-content-center">
              <a href="#services" class="btn btn-warning btn-lg me-3">Jelajahi Layanan</a>
              <a href="#contact" class="btn btn-warning btn-lg me-3">Hubungi Kami</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-4 mb-3">
            <div class="card border-warning">
              <div class="card-body">
                ...
                <a href="katalog.php" class="btn btn-warning mt-3 mb-2 w-100">Lihat Katalog</a>
                <a href="paket.php" class="btn btn-warning w-100">Pesan Sekarang</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-3">
